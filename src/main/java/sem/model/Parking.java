...
public class Parking {
	 ...
	 * 
	 * if ((startTime >= Integer.valueOf(startTimeCity)) && (startTime <
	 * Integer.valueOf(endTimeCity))) {
	 ...
	 * }
	 * } else {
	 * return (new Message("No puede estacionar fuera del horario operable de " +
	 * city.getStartTime() + " a "
	 * + city.getEndTime() + "hs "));
	 * }
	 * 
	 ...
	 * }
	 * 
	 * public static boolean isNonWorkingDate(String date, Iterable<Holiday>
	 * holidays) {
	 ...
	 * return new TimePriceDTO(this.getPatent(),hour,Math.floor((seconds % 3600)
	 * /60),(minutes * valueByFraction) + (hour * city.getValueByHour()));
	 * 
	 * } else {
	 * 
	 * // si pasa de a 15 minutos y pico ,te cobra los minutos que pasaron como si
	 * // fueran 15
	 * double account = (minutes * valueByFraction) + (hour * city.getValueByHour())
	 * + valueByFraction;
	 * return new TimePriceDTO(this.getPatent(),hour,Math.floor((seconds % 3600)
	 * /60),account);
	 * 
